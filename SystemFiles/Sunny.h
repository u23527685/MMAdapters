 ...
 * fertilization tailored to plants that thrive in sunny conditions
 * @author Jay
 */
class Sunny : public PlantCareRoutine
{
  ...
  public:
     ...
     * @details Implements the fertilizing strategy specific to plants in sunny
     * conditions
     ...
     * @details Implements the watering strategy specific to plants in sunny
     * conditions
     ...
     * @details Implements the sunlight strategy specific to plants in sunny
     * conditions
