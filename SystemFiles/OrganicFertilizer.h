...
class OrganicFertilizer : public FertilizerStrategy
{
  public:
     ...
     * This method applies the organic fertilizer strategy to the given plant by
     * increasing its nutrient level.
     ...
     * @warning This method assumes that the plant's current nutrient level and
     * maximum nutrient level are valid.
     * @note The plant's nurient level will be capped at its maximum water level
