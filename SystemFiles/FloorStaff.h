...
class FloorStaff : public Staff
{
  public:
    ...
    /**
     * @brief Determine whether this staff member can handle queries of the
     * given type.
     *
     ...
     *
     * Called when staffCanHandle(query->getType()) returns true.
     * Implementations should output or otherwise process the Query and may
     * forward it if further escalation is required.
     *
