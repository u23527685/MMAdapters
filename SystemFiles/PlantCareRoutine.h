 ...
 * @details Provides a framework for implementing different plant care strategies
 */
class PlantCareRoutine {
public:
    /**
     ...
     * @return std::unique_ptr<PlantCareRoutine> Smart pointer to created care routine
     */
