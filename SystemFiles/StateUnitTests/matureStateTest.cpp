...
TEST_CASE("MatureState: evaluate returns healthy when all resources >= 120% of min and <= max") {
    ...
    PlantLifeCycle* plc = new PlantLifeCycle(r, std::make_unique<MatureState>(), "HealthyMature #1");
...
TEST_CASE("MatureState: evaluate transitions to Distressed when any resource == min") {
    ...
    PlantLifeCycle* plc = new PlantLifeCycle(r, std::make_unique<MatureState>(), "DistressCase #1");
...
TEST_CASE("MatureState: evaluate transitions to Withered when any resource < min") {
    ...
    PlantLifeCycle* plc = new PlantLifeCycle(r, std::make_unique<MatureState>(), "WitheredCase #1");
...
TEST_CASE("MatureState: applyCare can raise borderline resources into healthy range (applyCare + evaluate)") {
    ...
    PlantLifeCycle* plc = new PlantLifeCycle(r, std::make_unique<MatureState>(), "RecoverMature #1");
...
TEST_CASE("MatureState: evaluate transitions to Distressed when multiple resources == min") {
    ...
    PlantLifeCycle* plc = new PlantLifeCycle(r, std::make_unique<MatureState>(), "MultiDistressCase #1");
...
TEST_CASE("MatureState: evaluate transitions to Withered when multiple resources < min") {
    ...
    PlantLifeCycle* plc = new PlantLifeCycle(r, std::make_unique<MatureState>(), "MultiWitheredCase #1");
...
TEST_CASE("MatureState: evaluate returns healthy when resources are at max") {
    ...
    PlantLifeCycle* plc = new PlantLifeCycle(r, std::make_unique<MatureState>(), "MaxResources #1");
