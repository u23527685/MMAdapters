...
TEST_CASE("PlantState: Seedling care application") {
    ...
    PlantLifeCycle* lifecycle = new PlantLifeCycle(plant, std::make_unique<SeedlingState>(), "Test");
...
TEST_CASE("PlantState: Seedling evaluation for Sunny plant") {
    ...
    PlantLifeCycle* lifecycle = new PlantLifeCycle(plant, std::make_unique<SeedlingState>(), "Eval");
...
TEST_CASE("PlantState: Seedling evaluation for Shade plant") {
    ...
    PlantLifeCycle* lifecycle = new PlantLifeCycle(plant, std::make_unique<SeedlingState>(), "ShadeEval");
