 ...
 * @brief Defines the DecorativePot class, a decorator that adds decorative pot features to a plant.
 */
...
public:
    ...
    /**
     * @brief Calculates the total price of the plant including the decorative pot.
