...
void Temperate::Fertilizing(Plant *p) { fS->applyFertilizer(p); }
void Temperate::Watering(Plant *p) { wS->applyWater(p); }
void Temperate::Sunlight(Plant *p) { sS->applySunlight(p); }
