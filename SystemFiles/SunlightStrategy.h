 ...
 * This class defines the interface for sunlight strategies, which determine how
 * much sunlight to apply to a plant. Concrete strategy classes should inherit
 * from this class and implement the applySunlight and getStrategyName methods.
 */
