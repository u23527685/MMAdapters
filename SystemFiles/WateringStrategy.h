 ...
 * This class defines the interface for water strategies, which determine how
 * much water to apply to a plant. Concrete strategy classes should inherit from
 * this class and implement the applyWater and getStrategyName methods.
 */
