...
class Staff : public LifeCycleObserver {
    private:
        ...
        SalesFloorObserver* salesFloorObserver; /**< Optional sales-floor observer (non-owning) */
    ...
    public:
        ...
        /**
         * @brief Notification callback from PlantLifeCycle to indicate health state.
         *
