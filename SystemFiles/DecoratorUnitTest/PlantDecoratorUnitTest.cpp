...
TEST_F(PlantDecoratorTest, GiftWrapBasicPlant) {
    ...
    EXPECT_TRUE(giftWrappedBasic->getDescription().find("Gift Wrapped") != std::string::npos);
...
TEST_F(PlantDecoratorTest, GiftWrapCustomPlant) {
    ...
    EXPECT_TRUE(giftWrappedCustom->getDescription().find("Orchid") != std::string::npos);
    EXPECT_TRUE(giftWrappedCustom->getDescription().find("Gift Wrapped") != std::string::npos);
...
TEST_F(PlantDecoratorTest, DecorativePotBasicPlant) {
    ...
    EXPECT_TRUE(pottedBasic->getDescription().find("Decorative Pot") != std::string::npos);
...
TEST_F(PlantDecoratorTest, DecorativePotCustomPlant) {
    ...
    EXPECT_TRUE(pottedCustom->getDescription().find("Bonsai Tree") != std::string::npos);
    EXPECT_TRUE(pottedCustom->getDescription().find("Decorative Pot") != std::string::npos);
...
TEST_F(PlantDecoratorTest, SpecialArrangementBasicPlant) {
    ...
    EXPECT_TRUE(arrangedBasic->getDescription().find("Special Arrangement") != std::string::npos);
...
TEST_F(PlantDecoratorTest, SpecialArrangementCustomPlant) {
    ...
    EXPECT_TRUE(arrangedCustom->getDescription().find("Exotic Flower Bouquet") != std::string::npos);
    EXPECT_TRUE(arrangedCustom->getDescription().find("Special Arrangement") != std::string::npos);
...
TEST_F(PlantDecoratorTest, NegativePricePlant) {
    ...
    // Price after decoration could still be negative or positive depending on implementation
