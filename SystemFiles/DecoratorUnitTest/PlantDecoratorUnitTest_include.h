...
TEST_CASE("Decorator: Gift Wrap Basic Plant") {
    ...
    CHECK(giftWrappedBasic->getDescription().find("Gift Wrapped") != std::string::npos);
...
TEST_CASE("Decorator: Gift Wrap Custom Plant") {
    ...
    CHECK(giftWrappedCustom->getDescription().find("Orchid") != std::string::npos);
    CHECK(giftWrappedCustom->getDescription().find("Gift Wrapped") != std::string::npos);
...
TEST_CASE("Decorator: Decorative Pot Basic Plant") {
    ...
    CHECK(pottedBasic->getDescription().find("Decorative Pot") != std::string::npos);
...
TEST_CASE("Decorator: Decorative Pot Custom Plant") {
    ...
    CHECK(pottedCustom->getDescription().find("Bonsai Tree") != std::string::npos);
    CHECK(pottedCustom->getDescription().find("Decorative Pot") != std::string::npos);
...
TEST_CASE("Decorator: Special Arrangement Basic Plant") {
    ...
    CHECK(arrangedBasic->getDescription().find("Special Arrangement") != std::string::npos);
...
TEST_CASE("Decorator: Special Arrangement Custom Plant") {
    ...
    CHECK(arrangedCustom->getDescription().find("Exotic Flower Bouquet") != std::string::npos);
    CHECK(arrangedCustom->getDescription().find("Special Arrangement") != std::string::npos);
