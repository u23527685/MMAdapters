...
Transaction::Transaction(const std::string &orderNum, double amount,
                         int quantity)
...
void Transaction::setTransaction(const std::string &orderNum, double amount,
                                 int quantity)
{
...
std::string Transaction::getTransactionId() const { return orderNum; }
