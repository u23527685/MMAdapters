 ...
 *          tailored to plants that thrive in shaded conditions
 */
class Shade: public PlantCareRoutine {
    ...
    public:
         ...
         * @details Implements the fertilizing strategy specific to plants in shaded conditions
         ...
         * @details Implements the watering strategy specific to plants in shaded conditions
         ...
         * @details Implements the sunlight strategy specific to plants in shaded conditions
